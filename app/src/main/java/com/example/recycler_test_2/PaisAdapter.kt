...
class PaisAdapter (var datos: MutableList<Pais>,var datos_secundarios: MutableList<Pais>, private val listener: OnClickListener): RecyclerView.Adapter<PaisAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        Log.v("start of bind", datos.toString())
        ...
        holder.binding.pacified.setOnCheckedChangeListener { _, isChecked ->
            ...
            Log.v("datos_changed", datos.toString())

            var lista_conjunta = datos + datos_secundarios
            listener.onCountryChanged(lista_conjunta.toMutableList())
        }
